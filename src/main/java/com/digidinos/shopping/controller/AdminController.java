...
public class AdminController {
	...
	public String productSave(Model model, //
		...
		try {
			productREPO.saveProduct(productForm);
		} catch (Exception e) {
	...
	public String orderView(Model model, @RequestParam("orderId") String orderId) {
	    ...
	    String orderStatus = orderREPO.getOrderStatus(orderId);
	        ...
	        if (order != null) {
	            ...
	            if ("Đã xác nhận".equals(status)) { 
	                for (OrderDetail detail : order.getOrderDetails()) {
	                    ...
	                    int quantityInStock = productREPO.getStockQuantityByProductCode(productCode);
	                    productREPO.updateProductQuantity(productCode, quantityInStock - quantityOrdered);
	                }
	            }
